...
FB_ODFTranslations["enUS"] = {
   ...
   CONFIG_COMBATSWITCH_ONOFF = "Combat switch",
   CONFIG_COMBATSWITCH_INFO = "Temporarily switch to weapons when attacked",
   CONFIG_ANYPOLE_ONOFF = "Use any pole",
   CONFIG_TABARD_INFO = "Include the Angler's Tabard in the Fishing Outfit.",
   CONFIG_TABARD_ONOFF = "Angler's Tabard",
   CONFIG_ANYPOLE_INFO = "Use any available fishing pole at random",
   CONFIG_OUTFITDISPLAY_ONOFF = "Outfit Display Options",
   CONFIG_OUTFITDISPLAY_INFO = "Miscellaneous customizations to how outfits are managed", 
